...
If you're using [xUnit.net](https://xunit.net/) to write tests, you may want to check out [Quibble.Xunit](https://github.com/einarwh/Quibble.Xunit), an extension to XUnit that does asserts on text strings with JSON content.
